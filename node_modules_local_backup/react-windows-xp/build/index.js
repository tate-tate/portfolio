...
var Button = function (_a) {
    ...
    return React__default['default'].createElement("button", __assign({}, rest), children);
};

var Checkbox = function (_a) {
    var id = _a.id, onChange = _a.onChange, children = _a.children, rest = __rest(_a, ["id", "onChange", "children"]);
    return (React__default['default'].createElement("div", { className: "field-row" },
        React__default['default'].createElement("input", __assign({}, rest, { onChange: function (evt) { return onChange(evt.target.checked); }, type: "checkbox", id: id })),
        React__default['default'].createElement("label", { htmlFor: id }, children)));
};

var Dropdown = function (_a) {
    var children = _a.children, onChange = _a.onChange, value = _a.value, rest = __rest(_a, ["children", "onChange", "value"]);
    return (React__default['default'].createElement("select", __assign({}, rest, { value: value, onChange: function (evt) { return onChange(evt.target.value); } }), children));
};
var DropdownOption = function (_a) {
    var id = _a.id, children = _a.children, rest = __rest(_a, ["id", "children"]);
    return (React__default['default'].createElement("option", __assign({}, rest, { value: id, id: id }), children));
};

var RadioButton = function (_a) {
    var group = _a.group, id = _a.id, onClick = _a.onClick, label = _a.label, rest = __rest(_a, ["group", "id", "onClick", "label"]);
    return (React__default['default'].createElement("div", { className: "field-row" },
        React__default['default'].createElement("input", __assign({}, rest, { onClick: function () { return onClick(id); }, id: id, type: "radio", name: group, value: label })),
        React__default['default'].createElement("label", { htmlFor: id }, label)));
};

var Slider = function (_a) {
    var id = _a.id, onChange = _a.onChange, vertical = _a.vertical, label = _a.label, boxIndicator = _a.boxIndicator, rest = __rest(_a, ["id", "onChange", "vertical", "label", "boxIndicator"]);
    return (React__default['default'].createElement("div", { className: "field-row" },
        React__default['default'].createElement("label", { htmlFor: id }, label),
        React__default['default'].createElement("div", { className: vertical ? "is-vertical" : "" },
            React__default['default'].createElement("input", __assign({}, rest, { className: boxIndicator ? "has-box-indicator" : "", type: "range", onChange: function (evt) { return onChange(Number(evt.target.value)); } })))));
};

var TextBox = function (_a) {
    var id = _a.id, stacked = _a.stacked, label = _a.label, onChange = _a.onChange, rest = __rest(_a, ["id", "stacked", "label", "onChange"]);
    var className = stacked ? "field-row-stacked" : "field-row";
    return (React__default['default'].createElement("div", { className: className },
        React__default['default'].createElement("label", { htmlFor: id }, label),
        React__default['default'].createElement("input", __assign({}, rest, { onChange: function (evt) { return onChange(evt.target.value); }, type: "text" }))));
};

var css_248z$1 = ".winxp-font {\n  -webkit-font-smoothing: antialiased;\n  -moz-osx-font-smoothing: grayscale;\n  font-family: \"Noto Sans TC\", sans-serif;\n}\n\n.pixelated {\n  font-family: \"Pixelated MS Sans Serif\";\n}\n";
styleInject(css_248z$1);

var Typography = function (_a) {
    var variant = _a.variant, children = _a.children, pixelated = _a.pixelated, rest = __rest(_a, ["variant", "children", "pixelated"]);
    if (variant === "terminal") {
        return React__default['default'].createElement("pre", null, children);
    }
    var className = pixelated ? "winxp-font pixelated" : "winxp-font";
    var Tag = {
        paragraph: "p",
    }[variant] || variant;
    return (React__default['default'].createElement(Tag, __assign({ className: className }, rest), children));
};

var css_248z = ".wallpaper {\n  overflow: hidden;\n  background: url(https://i.imgur.com/Zk6TR5k.jpg) no-repeat center center fixed;\n  background-size: cover;\n}\n\n.wallpaper *:not(input):not(textarea) {\n  user-select: none;\n}\n";
styleInject(css_248z);

var Wallpaper = function (_a) {
    var children = _a.children, fullScreen = _a.fullScreen, rest = __rest(_a, ["children", "fullScreen"]);
    var fullScreenStyles = fullScreen
        ...
        : {};
    return (React__default['default'].createElement("div", __assign({}, rest, { className: "wallpaper " + rest.className, style: fullScreenStyles }), children));
};

var Window = function (_a) {
    var title = _a.title, showClose = _a.showClose, showMaximize = _a.showMaximize, showMinimize = _a.showMinimize, showHelp = _a.showHelp, onClose = _a.onClose, onMaximize = _a.onMaximize, onMinimize = _a.onMinimize, onHelp = _a.onHelp, children = _a.children, rest = __rest(_a, ["title", "showClose", "showMaximize", "showMinimize", "showHelp", "onClose", "onMaximize", "onMinimize", "onHelp", "children"]);
    return (React__default['default'].createElement("div", __assign({}, rest, { className: "window" }),
        React__default['default'].createElement("div", { className: "title-bar" },
            React__default['default'].createElement("div", { className: "title-bar-text" }, title),
            React__default['default'].createElement("div", { className: "title-bar-controls" },
                showMinimize && (React__default['default'].createElement("button", { "aria-label": "Minimize", onClick: onMinimize })),
                showMaximize && (React__default['default'].createElement("button", { "aria-label": "Maximize", onClick: onMaximize })),
                showHelp && React__default['default'].createElement("button", { "aria-label": "Help", onClick: onHelp }),
                showClose && React__default['default'].createElement("button", { "aria-label": "Close", onClick: onClose }))),
        React__default['default'].createElement("div", { className: "window-body" }, children)));
};

var img = "data:image/png;base64,";

var Error = function (_a) {
    var onClose = _a.onClose, title = _a.title, children = _a.children, _b = _a.iconSize, iconSize = _b === void 0 ? 48 : _b, _c = _a.confirmText, confirmText = _c === void 0 ? "Ok" : _c, onConfirm = _a.onConfirm, windowProps = __rest(_a, ["onClose", "title", "children", "iconSize", "confirmText", "onConfirm"]);
    return (React__default['default'].createElement(Window, __assign({ title: title, onClose: onClose }, windowProps, { showClose: true }),
        React__default['default'].createElement("div", { style: { textAlign: "center" } },
            React__default['default'].createElement("div", { style: { display: "flex" } },
                React__default['default'].createElement("img", { src: img, alt: "Error", width: iconSize, height: iconSize }),
                children),
            React__default['default'].createElement(Button, { onClick: onConfirm }, confirmText))));
};
